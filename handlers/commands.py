...
async def about_info(message: Message):
    about_message = "Привет!\n1.Предложу тебе множество достопримечательностей,\n2.расскажу минимальную цену на недельный тур в выбранный город,\n3.подберу подходящий город по твоему бюджету.\nТут можешь познакомиться с ботом 👇"
